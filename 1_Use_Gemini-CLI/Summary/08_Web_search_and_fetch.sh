# =============================================================
## 1. How to research new technologies
## 2. How to fetch deep context
## 3. How to apply knowledge to code
...
#
# Imagine you want to use a library released yesterday.
# The model doesn't know about it yet.
...
#
# Gemini uses the `google_web_search` tool to find relevant pages
# and synthesizes an answer.
#
# This "grounding" process ensures
# the agent isn't hallucinating features that don't exist.
#
# **Prompt:**
...
#
# Search gives you a summary,
# but sometimes you need the raw details.
# The `web_fetch` tool lets you feed a specific URL
...
#
# Gemini will retrieve the page content
...
Read this guide: <https://supabase.com/docs/guides/auth >.
# 3. **Implement:** "Great. Now use that pattern to create an 'auth.ts' file in my project."
Great. Now use that pattern to create an 'auth.ts' file in my project.
...
Im getting Error: hydration mismatch in Next.js. Search for recent solutions.
#
# The agent will search sources such as GitHub issues, StackOverflow,
# and forums to find relevant fixes
# that might be too new to be in its base training set.
