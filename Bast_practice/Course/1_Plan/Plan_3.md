...
```toml
I'm starting a new project and I'd like to create a knowledge base
for you to reference throughout our development process.
...
and suggest any additional details
we should include in our knowledge base?
```
