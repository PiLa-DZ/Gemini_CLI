...
> [!NOTE]
> **_This is Developer guide: Best practices_**
...
This guide covers best practices for developing, securing,
and maintaining Gemini CLI extensions.

## Development

Developing extensions for Gemini CLI is a lightweight, iterative process.
Use these strategies to build robust and efficient extensions.
